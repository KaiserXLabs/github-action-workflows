...
`KaiserXLabs/github-action-workflows/.github/workflows/build-and-push-docker-image.yml@v3`
...
jobs:
  ...
  buildAndPushDockerImage:
    ...
    uses: KaiserXLabs/github-action-workflows/.github/workflows/build-and-push-docker-image.yml@v3 # x-release-please-major
    with:
...
`KaiserXLabs/github-action-workflows/.github/workflows/package-and-push-helm-chart.yml@v3`
...
jobs:
  ...
  packageAndPushHelmChart:
    ...
    needs: release-please
    uses: KaiserXLabs/github-action-workflows/.github/workflows/package-and-push-helm-chart.yml@v3 # x-release-please-major
    with:
