...
Workflow name: `KaiserXLabs/reusable-github-workflows/build-and-push-docker-image.yml`
...
jobs:
  ...
  buildAndPushDockerImage:
    ...
    uses: KaiserXLabs/reusable-github-workflows/build-and-push-docker-image.yml
    with:
